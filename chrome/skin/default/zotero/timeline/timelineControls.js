...
function doKeyPress(e)
{
	...
	if (activeCalendar=='persian') {
		lastJumpToYearValue=(parseInt(lastJumpToYearValue)+621).toString();
	}
	//</abszh>
...
function setupOtherControls(div, timeline, url) {
	...
	options = new Array(Zotero.getString("itemFields.dateAdded"), getString("dateType.modified"),getString("dateType.published"));
	var values = new Array('da', 'dm','d');
	//</abszh>
