...
var Zotero_Browser = new function() {
	...
	function chromeLoad() {
		...
		//DOMSubtreeModified
//		this.appcontent.addEventListener("DOMFrameContentLoaded",
//			function(e) {
//				Zotero.debug("DOMFrameContentLoaded");
//				Zotero_Browser.contentLoad(e);
//			}, true);
	...
	function contentLoad(event) {
		...
		//<abszh>
//		Zotero.debug("isHTML is: "+isHTML.toString());
//		Zotero.debug("fab doc is: "+doc.toSource());
		//</abszh>
